/**
 * This small library is based on string-similarity by aceakash (https://github.com/aceakash/string-similarity)
 * The original version does not support a comparison of a documents property with a search string.
 * Because of that, the function findBestMatchByProp was added.
 */
...
function setRatingsByProp(mainString, targetDocuments, mapFn) {
    ...
    function areArgsValid(mainString, targetDocuments, mapFn) {
        ...
        var mapFnIsAFunction = (typeof mapFn === 'function');

        return mainStringIsAString && targetStringsIsAnArrayOfDocuments && mapFnIsAFunction;
    }
}